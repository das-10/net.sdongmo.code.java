 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://jawxs.fhk.prakt2/jaxws/bankservice", wsdlLocation = "http://localhost:55555/bankservices?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://jawxs.fhk.prakt2/jaxws/bankservice", "BankService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:55555/bankservices?wsdl");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://jawxs.fhk.prakt2/jaxws/bankservice", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jawxs.fhk.prakt2/jaxws/bankservice", "BankServicePort"), BankService.class, features);
    }
